<div>
    <style>
        ...
        .wishlisted{
            background-color: #008919 !important;
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        ...
                        <div class="sidebar-widget price_range range mb-30">
                                ...
                                <div class="price-filter-inner">
                                    ...
                                    <div class="price_slider_amount">
                                        <div class="label-input">
                                            <span>Range:</span> <span class="text-info">Rs: {{$min_value}}</span> - <span class="text-info">Rs: {{$max_value}}</span>
                            ...
                            <a href="{{route('shop')}}" class="btn btn-sm btn-default"><i class="fi-rs-filter mr-5"></i> Filter</a>
                        </div>
