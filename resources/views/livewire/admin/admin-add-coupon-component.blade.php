                            ...
                            <div class="card-body">
                               ...
                               <form wire:submit.prevent="storeCoupon">
                                ...
                                <div class="md-3 mt-3">
                                    ...
                                    <input type="text" name="Coupon Value" class="form-control" placeholder="Enter coupon value" wire:model="value">
                                    @error('value')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                                </div>
                                 <div class="md-3 mt-3">
                                    ...
                                    <input type="text" name="Cart Value" class="form-control" placeholder="Enter cart value" wire:model="cart_value">
                                    @error('cart_value')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                                </div>
