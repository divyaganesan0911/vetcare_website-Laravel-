                    ...
                    <form wire:submit.prevent="placeOrder">
                        <div class="col-md-6">
                            <div class="mb-25">
                                ...
                                <div class="form-group">
                                    <input required="" type="text" name="country" placeholder="Country *" wire:model="country">
                        ...
                        <!-- Shipping Address Section (conditionally displayed) -->
                        @if($ship_to_different)
                            <div class="col-md-6">
                                <div class="mb-25">
                                    ...
                                    <div class="form-group">
                                        <input required="" type="text" name="country" placeholder="Country *" wire:model="s_country">
