                                    ...
                                    <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                        <ul>
                                            ...
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="{{route('product.details',['slug'=>$item->model->slug])}}"><img alt="{{$item->model->name}}" src="{{ asset('assets/imgs/products')}}/{{$item->model->image}}" alt=""></a>
                                                </div>
                                                <div class="shopping-cart-title">
                                                    <h4><a href="{{route('product.details',['slug'=>$item->model->slug])}}">{{substr($item->model->name,0,20)}}...</a></h4>
                                                    <h4><span>{{$item->qty}} x </span>Rs: {{$item->model->regular_price}}</h4>
                                                </div>
                                        ...
                                        <div class="shopping-cart-footer">
                                            <div class="shopping-cart-total">
                                                <h4>Total <span>Rs: {{Cart::instance('cart')->total()}}</span></h4>
                                            </div>
